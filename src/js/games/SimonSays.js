...
*/
PlaySearch.SimonSays = function (game) {};

PlaySearch.SimonSays.prototype = {
    create: function () {
	...
	menuPress: function(){ //calls when menu button is pressed
	...
	////DRAW THINGS
	drawSprite: function(x, y, sprite, key, scale){
	...
	drawPlayerOptions: function(x, y, sprite, key, scale){
	    var obj = this.game.add.sprite(x, y, sprite);
	    obj.frame = key;
	    obj.scale.set(scale);
	...
	changeSprite: function(object, key){
	    object.frame = key;
	},
	//Action
	playerChoice: function(object){   
	...
	createRectangle: function(x, y, w, h, fillHex, outline) {
