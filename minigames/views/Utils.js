...
MaestroGameBuilder.Options = {
	...
	baseHeight: 1080,
	testFeature: false,
	indexState: 'LevelMenu',
	progress: 0,
	SimonSays: {
		setting1: true
	},
	urlBase: '/wp-content/plugins/maestro-game-builder/'
};
...
MaestroGameBuilder.Utils.prototype = {
        ...
        if(!this.game.modal){
	        ...
	        if(event.x>this.game.pauseLayerQuitButton.x-(this.game.pauseLayerQuitButton.width/2)
	            ...
	            window.setTimeout(function(){
	            	...
	            	if((MaestroGameBuilder.Options.gameType=='minigames_menu'&&self.game.state.current!=MaestroGameBuilder.Options.indexState)||self.game.state.current==MaestroGameBuilder.Options.indexState&&MaestroGameBuilder.Options.searchMode==true){
    ...
    launchModal: function( title, text, context, callback, pause ) {
    	...
    	menuImg.src = MaestroGameBuilder.Options.urlBase+'minigames/default_assets/general/ModalMenu@3x.png';
